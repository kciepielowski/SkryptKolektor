...
public class ListData {
	 ...
	 */
	    ...
	    public boolean isGraphics() {
	    	...
	    	String[] graphicsExts = {"jpg","jpeg","png","gif","bmp","tiff","ico"}; //lista rozszerzeń traktowanych jako obraz
	    	return Arrays.stream(graphicsExts).anyMatch(ext::equals);	// zwróć wynik porównania
	    }
}
