...
public class OknoObraz extends JFrame {

	private static final long serialVersionUID = 1L; 

public static int id; //id pliku z brazem
private ImageIcon obraz; // sam obraz jako ikona do podstawienia w labelkę
	public OknoObraz(int id) {
		/**
		...
		rs = stmt.executeQuery(sql);
					while (rs.next()) {
				        ...
				        obraz= new ImageIcon(ImageIO.read(rs.getBinaryStream("plik")) );
					}
